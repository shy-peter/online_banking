...
const Settings = () => {
  ...
  const totalInvested = investments?.reduce((sum, inv) => sum + (inv.status === 'active' ? inv.amount : 0), 0) || 0;
  ...
  const handleAddPaymentMethod = async () => {
    ...
    switch (newPaymentMethod.type) {
      ...
      case 'venmo':
        if (newPaymentMethod.email || newPaymentMethod.username || newPaymentMethod.phoneNumber) {
          displayName = 'Venmo';
          displayAccount = newPaymentMethod.username ? `@${newPaymentMethod.username}` : 
    ...
    const paymentMethodData = {
      type: newPaymentMethod.type as 'paypal' | 'venmo' | 'cashapp' | 'usdt' | 'ethereum' | 'bitcoin',
      name: displayName,
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="ml-3">
                          ...
                          <p className="text-sm text-blue-700 mt-1">
                            Payment method details must match your account information exactly. All payment methods will be pending verification before they can be approved for withdrawals. Please ensure all information is accurate and up-to-date.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-4">
                              ...
                              <div>
                                ...
                                {method.email && (
                                  <ClickToCopy text={method.email} copyMessage="Email copied to clipboard!">
                                ...
                                <div className="flex items-center space-x-2 mt-1">
                                  <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${
                                    ...
                                    {method.status === 'verified' ? 'Verified' : 
                                     method.status === 'rejected' ? 'Rejected' : 'Pending'}
                                  </span>
                                  {method.isDefault && (
                      ...
                      {paymentMethods.length === 0 && (
                        <div className="text-center py-12">
                          ...
                          <p className="text-gray-600 mb-4">Add a payment method to enable withdrawals</p>
                          <button
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                        <div>
                          ...
                          <p className="text-sm text-gray-600">Display account balance in dashboard</p>
                        </div>
                        <label className="relative inline-flex items-center cursor-pointer">
                          <input
                            type="checkbox"
                            checked={showBalance}
                            onChange={(e) => handleShowBalanceToggle(e.target.checked)}
                            className="sr-only peer"
                          />
                          <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary-600"></div>
                        </label>
                      ...
                      <div className="p-4 border border-gray-200 rounded-lg">
                        ...
                        <p className="text-sm text-gray-600 mb-4">Select your preferred currency</p>
                        <select 
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
            ...
            <div className="space-y-4">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-2">
                    <p className="text-xs text-amber-800">
                      <strong>Important:</strong> Payment details must match your account information. All methods require verification before approval.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setNewPaymentMethod(prev => ({ ...prev, username: e.target.value }))}
                      className="form-input"
              ...
              {(newPaymentMethod.type === 'usdt' || newPaymentMethod.type === 'ethereum' || newPaymentMethod.type === 'bitcoin') && (
                <div>
                  <label className="form-label">
                    {newPaymentMethod.type === 'usdt' ? 'USDT Address' :
                     newPaymentMethod.type === 'ethereum' ? 'Ethereum Address' :
                     'Bitcoin Address'}
                  </label>
                  <input
                    type="text"
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Make sure to use the correct network for {newPaymentMethod.type.toUpperCase()}. 
                    <span className="text-amber-600 font-medium"> This address must be under your control and match your account verification.</span>
                  </p>
                </div>
              )}
