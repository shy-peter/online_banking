  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <nav className="fixed top-0 w-full bg-black/95 backdrop-blur-md border-b border-gray-800 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a
                href="#home"
                className="nav-link text-gray-300 hover:text-white font-medium transition-colors"
              >
                Home
              </a>
              <a
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <button
                ...
                className="bg-[#d8ed36] hover:bg-[#c4d630] text-black px-6 py-2 rounded-full font-semibold transition-all duration-200 transform hover:scale-105"
              >
                Get Started
              </button>
            </div>
        ...
        <div
          id="mobile-menu"
          className="md:hidden hidden bg-black border-t border-gray-800"
        >
          <div className="px-4 py-4 space-y-3">
            ...
            <div className="pt-4 border-t border-gray-800 space-y-3">
              ...
              <button
                onClick={handleSignupClick}
                className="block w-full bg-[#d8ed36] text-black px-4 py-2 rounded-full font-semibold"
              >
                Get Started
              </button>
            </div>
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl lg:text-2xl text-gray-300 leading-relaxed max-w-lg">
                  Send, spend, bank, and invest with InvestFlow Bank. The
              ...
              <div className="grid grid-cols-3 gap-8 py-8">
                <div className="text-center">
                  <div className="text-3xl lg:text-4xl font-bold text-[#d8ed36] mb-2">
                    50M+
                  </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link
                  to="/login"
                  className="border-2 border-white text-center text-white px-8 py-4 rounded-full font-semibold hover:bg-white hover:text-black transition-all duration-200 text-lg"
                >
                  Login
                </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From everyday banking to wealth management, we provide a full
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl p-8 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-700 mb-6">
                Complete banking solutions for individuals including checking,
                savings, and personal loans.
              </p>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-center">
                  <Check className="w-4 h-4 text-[#d8ed36] mr-2" />
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-100 rounded-2xl p-8 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-700 mb-6">
                Tailored solutions for businesses of all sizes to manage cash
                flow and growth.
              </p>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-center">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-violet-100 rounded-2xl p-8 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-700 mb-6">
                Professional investment management and wealth advisory services.
              </p>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-center">
                  <Check className="w-4 h-4 text-[#d8ed36] mr-2" />
            ...
            <div className="bg-gradient-to-br from-orange-50 to-amber-100 rounded-2xl p-8 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-700 mb-6">
                24/7 online and mobile banking with cutting-edge technology.
              </p>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-center">
                  <Check className="w-4 h-4 text-[#d8ed36] mr-2" />
            ...
            <div className="bg-gradient-to-br from-red-50 to-pink-100 rounded-2xl p-8 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-700 mb-6">
                Flexible credit options including cards, lines of credit, and
                mortgages.
              </p>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-center">
            ...
            <div className="bg-gradient-to-br from-teal-50 to-cyan-100 rounded-2xl p-8 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-700 mb-6">
                Comprehensive insurance products to protect what matters most.
              </p>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-center">
                  <Check className="w-4 h-4 text-[#d8ed36] mr-2" />
      ...
      <section id="features" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Experience banking reimagined with innovative features designed
            ...
            <div className="space-y-8">
              <div className="feature-card flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Send and receive money instantly with our advanced payment
                    processing system.
                  </p>
                </div>
              </div>
              ...
              <div className="feature-card flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Access your account from anywhere in the world with no
                    international fees.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-3xl shadow-2xl p-8 transform rotate-3 hover:rotate-0 transition-transform duration-500">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-semibold text-[#d8ed36]">
                      24,567 pts
                    </span>
                  </div>
                </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Advanced security measures protect your financial information with
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm">
                Military-grade encryption protects all your data and
                transactions.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm">
                Round-the-clock fraud detection and prevention systems.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm">
                Real-time notifications for all account activities and
                transactions.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gray-800 rounded-2xl p-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center">
              ...
              <div className="text-center">
                <div className="bg-gray-700 rounded-lg p-4 mb-2">
                  <div className="text-2xl font-bold text-[#d8ed36]">
                    PCI DSS
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              to say about their InvestFlow Bank experience.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="testimonial-card bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl p-8">
              ...
              <p className="text-gray-700 mb-6 italic">
                "InvestFlow Bank has completely transformed how I manage my
                finances. The mobile app is intuitive and the customer service
                is exceptional."
              </p>
            ...
            <div className="testimonial-card bg-gradient-to-br from-green-50 to-emerald-100 rounded-2xl p-8">
              ...
              <p className="text-gray-700 mb-6 italic">
                "The investment management services have helped me grow my
                portfolio significantly. Their AI-powered insights are
                incredibly valuable."
              </p>
              <div className="flex items-center">
                <div className="w-12 h-12 bg-[#d8ed36] rounded-full flex items-center justify-center text-black font-bold mr-4">
            ...
            <div className="testimonial-card bg-gradient-to-br from-purple-50 to-violet-100 rounded-2xl p-8">
              ...
              <p className="text-gray-700 mb-6 italic">
                "As a frequent traveler, the global access and no international
                fees have saved me thousands. Best banking decision I've ever
                made."
              </p>
              <div className="flex items-center">
                <div className="w-12 h-12 bg-[#d8ed36] rounded-full flex items-center justify-center text-black font-bold mr-4">
      ...
      <section className="py-20 bg-black relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Join over 500,000 satisfied customers who trust InvestFlow Bank with
            their financial future.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={handleSignupClick}
              className="bg-[#d8ed36] text-black px-8 py-4 rounded-full font-semibold hover:bg-[#c4d630] transition-all duration-200 transform hover:scale-105 shadow-lg"
            >
          ...
          <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
            <div>
              <div className="text-2xl font-bold text-[#d8ed36] mb-1">
                2 Minutes
              </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <p className="text-gray-400 mb-6">
                ...
                solutions for a better financial future.
              </p>
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-[#d8ed36] hover:text-black transition-colors"
                >
            ...
            <div>
              ...
              <div className="space-y-3 text-gray-400">
                ...
                <div className="flex items-center">
                  ...
                  <span>Investflowbank@gmail.com</span>
                </div>
