@echo off
REM Setup Payment Method Types collection
...
appwrite databases create-collection --database-id "%DATABASE_ID%" --collection-id "payment-method-types" --name "Payment Method Types" --permissions "read(\"any\")" --permissions "create(\"any\")" --permissions "update(\"any\")" --permissions "delete(\"any\")"
...
REM Add default payment method types
appwrite databases create-document --database-id "%DATABASE_ID%" --collection-id "payment-method-types" --document-id "paypal" --data "{\"type\":\"paypal\",\"name\":\"PayPal\",\"description\":\"PayPal digital wallet and payment system\",\"icon\":\"CreditCard\",\"category\":\"digital_wallet\",\"requiredFields\":\"[\\\"email\\\"]\",\"optionalFields\":\"[\\\"username\\\", \\\"phoneNumber\\\"]\",\"isActive\":true,\"sortOrder\":1}"

appwrite databases create-document --database-id "%DATABASE_ID%" --collection-id "payment-method-types" --document-id "venmo" --data "{\"type\":\"venmo\",\"name\":\"Venmo\",\"description\":\"Venmo mobile payment service\",\"icon\":\"Smartphone\",\"category\":\"mobile_payment\",\"requiredFields\":\"[\\\"username\\\", \\\"phoneNumber\\\"]\",\"optionalFields\":\"[\\\"email\\\"]\",\"isActive\":true,\"sortOrder\":2}"

appwrite databases create-document --database-id "%DATABASE_ID%" --collection-id "payment-method-types" --document-id "cashapp" --data "{\"type\":\"cashapp\",\"name\":\"Cash App\",\"description\":\"Cash App mobile payment service\",\"icon\":\"Smartphone\",\"category\":\"mobile_payment\",\"requiredFields\":\"[\\\"username\\\", \\\"phoneNumber\\\"]\",\"optionalFields\":\"[\\\"email\\\"]\",\"isActive\":true,\"sortOrder\":3}"

appwrite databases create-document --database-id "%DATABASE_ID%" --collection-id "payment-method-types" --document-id "usdt" --data "{\"type\":\"usdt\",\"name\":\"USDT (Tether)\",\"description\":\"USDT cryptocurrency wallet\",\"icon\":\"DollarSign\",\"category\":\"cryptocurrency\",\"requiredFields\":\"[\\\"address\\\"]\",\"optionalFields\":\"[\\\"name\\\"]\",\"isActive\":true,\"sortOrder\":4}"

appwrite databases create-document --database-id "%DATABASE_ID%" --collection-id "payment-method-types" --document-id "ethereum" --data "{\"type\":\"ethereum\",\"name\":\"Ethereum\",\"description\":\"Ethereum cryptocurrency wallet\",\"icon\":\"DollarSign\",\"category\":\"cryptocurrency\",\"requiredFields\":\"[\\\"address\\\"]\",\"optionalFields\":\"[\\\"name\\\"]\",\"isActive\":true,\"sortOrder\":5}"

appwrite databases create-document --database-id "%DATABASE_ID%" --collection-id "payment-method-types" --document-id "bitcoin" --data "{\"type\":\"bitcoin\",\"name\":\"Bitcoin\",\"description\":\"Bitcoin cryptocurrency wallet\",\"icon\":\"DollarSign\",\"category\":\"cryptocurrency\",\"requiredFields\":\"[\\\"address\\\"]\",\"optionalFields\":\"[\\\"name\\\"]\",\"isActive\":true,\"sortOrder\":6}"
